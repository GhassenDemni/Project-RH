...
export default function Contact() {
  return (
    <section className="overflow-hiddenpy-4 relative">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <div className="mb-4 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  <h4 className="text-dark mb-1 font-bold">Phone Number</h4>
                  <a
                    href={`tel:${siteConfig.contact.phone}`}
                    className="text-body-color text-base underline"
                  >
              ...
              <div className="mb-4 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  <h4 className="text-dark mb-1 font-bold">Email Address</h4>
                  <a
                    className="text-body-color text-base underline"
